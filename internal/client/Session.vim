...
silent only
silent tabonly
cd ~/work_projects/go/go-musthave-metrics-tpl/internal/client
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess+=aoO
badd +0 main.go
badd +0 ~/work_projects/go/go-musthave-metrics-tpl/internal/stats/main.go
argglobal
%argdel
$argadd main.go
edit ~/work_projects/go/go-musthave-metrics-tpl/internal/stats/main.go
...
keepjumps 11
normal! 0
lcd ~/work_projects/go/go-musthave-metrics-tpl/internal/client
wincmd w
argglobal
if bufexists(fnamemodify("~/work_projects/go/go-musthave-metrics-tpl/internal/client/main.go", ":p")) | buffer ~/work_projects/go/go-musthave-metrics-tpl/internal/client/main.go | else | edit ~/work_projects/go/go-musthave-metrics-tpl/internal/client/main.go | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
